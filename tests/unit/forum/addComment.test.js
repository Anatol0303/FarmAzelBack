...
describe('PostServiceImpl.addComment', () => {
    ...
    it("Passed test", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        Post_1.Post.findByIdAndUpdate.mockResolvedValue(fakePostDto);
        const result = yield postService.addComment("1234", "TestUser", "TestMessage");
        expect(Post_1.Post.findByIdAndUpdate).toHaveBeenCalledWith(id, {
            $push: {
                comments: {
                    user: "TestUser",
                    message: "TestMessage",
    ...
    test("Failed test", () => __awaiter(void 0, void 0, void 0, function* () {
        Post_1.Post.findByIdAndUpdate.mockResolvedValue(null);
        yield expect(postService.addComment("UNKNOWN", "USER", "MESSAGE")).rejects.toThrow("post is null");
    }));
});
